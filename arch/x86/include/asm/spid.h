...
enum {
	...
	INTEL_CLVTP_PHONE_FALCON_PRO= 0x4643,	/* FC */
	INTEL_CLVTP_PHONE_FALCON_ENG= 0xc643,	/* FC */
...
/* Hardware_ID table for Product_Line_ID == INTEL_CLVTP_PHONE_FALCON */
enum {
	CLVTP_PHONE_FALCON_PR10,
	CLVTP_PHONE_FALCON_RSVD,	/* PR1.5 */
	CLVTP_PHONE_FALCON_PR16 = 0x1000,
	CLVTP_PHONE_FALCON_PR20
};
