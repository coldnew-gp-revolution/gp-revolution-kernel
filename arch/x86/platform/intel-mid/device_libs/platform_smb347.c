...
static struct smb347_charger_platform_data smb347_pdata_rhb0 = {
	...
	.max_charge_current		= 1000000,	/* Fast charge current(uA) */
	.pre_charge_current		= 250000,	/* Pre-charge current(uA) */
	.termination_current	= 90000,	/* Terminated-charge current(uA) */
	.mains_current_limit	= 1000000,	/* DCIN input current limit(uA) */
	.usb_hc_current_limit	= 1000000,	/* USBIN HC input current limit(uA) */
