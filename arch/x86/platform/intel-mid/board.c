...
#include "device_libs/platform_lsm303d.h"
...
#include "device_libs/platform_ft5x06.h"
...
#include "device_libs/platform_gt9xx.h"
#endif
/* SPI devices */
...
struct devs_id __initconst device_ids[] = {
	...
	{"ft5x06_ts", SFI_DEV_TYPE_I2C, 0, &ft5x06_platform_data, NULL},
	...
	{"lsm303d", SFI_DEV_TYPE_I2C, 0, &lsm303d_platform_data, NULL},
...
#endif
#ifdef CONFIG_TOUCHSCREEN_GOODIX_GT9XX
        {"Goodix-TS", SFI_DEV_TYPE_I2C, 0, &goodix9xx_platform_data, NULL},
#endif
