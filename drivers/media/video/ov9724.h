...
struct ov9724_device {
    ...
    u32 count;
    u32 stream_mode;  // 0: preview; 1: capture; 2: video
	u16 sensor_id;
	u16 coarse_itg;
	u16 fine_itg;
	u16 gain;
...
static struct ov9724_reg const ov9724_720p_30fps[] = {
	...
	{OV9724_8BIT, {0x0340},	0x06},/* Vertical length - Hi */
	{OV9724_8BIT, {0x0341},	0x84},/* Vertical length - Low */
	{OV9724_8BIT, {0x0342},	0x06},/* Horizontal length - Hi */ // 0x05--> 0x06
	{OV9724_8BIT, {0x0343},	0x28},/* Horizontal length - Low */ // 0x60--> 0x28
...
struct ov9724_resolution ov9724_res_preview[] = {
	...
	},
	{
		...
		.fps = 30,
		.pixels_per_line = 0x0560, /* consistent with regs arrays */
		.lines_per_frame = 0x0684, /* consistent with regs arrays */
		.bin_factor_x = 0,
		.bin_factor_y = 0,
		.used = 0,
		.skip_frames = 4,
