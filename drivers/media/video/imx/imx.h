...
#define IMX_PLL_MULTIPLIER_IMX111 0x0307
...
//#define IMX_EEPROM_DATA_SIZE		281 //1.0 version is 544, 1.6 version is 281
#define IMX_EEPROM_I2C_ADDR		0X50

#define IMX_EEPROM_SIZE		4096
...
#define IMX_FOCAL_LENGTH_NUM	294	/*3.69mm*/
#define IMX_FOCAL_LENGTH_DEM	100
#define IMX_F_NUMBER_DEFAULT_NUM	24
...
struct imx_settings imx_sets[] = {
	...
	[IMX111_ID] = {
		...
		.res_still = imx111_res_preview,
		.res_video = imx111_res_video,
		.n_res_preview = ARRAY_SIZE(imx111_res_preview),
		.n_res_still = ARRAY_SIZE(imx111_res_preview),
...
extern int vm149c_vcm_power_up(struct v4l2_subdev *sd);//for booyi module
extern int vm149c_vcm_power_down(struct v4l2_subdev *sd);
extern int vm149c_vcm_init(struct v4l2_subdev *sd);
extern int vm149c_t_focus_vcm(struct v4l2_subdev *sd, u16 val);
extern int vm149c_t_focus_abs(struct v4l2_subdev *sd, s32 value);
extern int vm149c_t_focus_rel(struct v4l2_subdev *sd, s32 value);
extern int vm149c_q_focus_status(struct v4l2_subdev *sd, s32 *value);
extern int vm149c_q_focus_abs(struct v4l2_subdev *sd, s32 *value);
extern int vm149c_t_vcm_slew(struct v4l2_subdev *sd, s32 value);
extern int vm149c_t_vcm_timing(struct v4l2_subdev *sd, s32 value);

extern int imx_vcm_power_up(struct v4l2_subdev *sd);//for lite-on module
...
struct imx_vcm imx_vcms[] = {
	...
	[IMX111_ID] = {
		...
		.t_vcm_slew = vm149c_t_vcm_slew,
		.t_vcm_timing = vm149c_t_vcm_timing,
	},
#if 0
	[IMX111_ID] = {
		.power_up = imx_vcm_power_up,
		.power_down = imx_vcm_power_down,
		.init = imx_vcm_init,
		.t_focus_vcm = imx_t_focus_vcm,
		.t_focus_abs = imx_t_focus_abs,
		.t_focus_rel = imx_t_focus_rel,
		.q_focus_status = imx_q_focus_status,
		.q_focus_abs = imx_q_focus_abs,
		.t_vcm_slew = imx_t_vcm_slew,
		.t_vcm_timing = imx_t_vcm_timing,
	},
#endif
	[IMX_ID_DEFAULT] = {
